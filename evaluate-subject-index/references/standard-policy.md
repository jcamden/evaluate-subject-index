...
For V6 reliability arithmetic only, an inspectable indexable page containing a genuine passing mention, attribution, citation, or incidental example may receive limited 0.25 misdirection credit. This does not satisfy this locator-quality rule: the assignment remains `unsupported`, editorially unjustified, zero-credit for Editorial Selectivity, and subject to every applicable defect, cap, and shipping gate. Wrong sense, relation, stance, compound scope, scope, fabricated, and nonexistent destinations receive no such credit.
