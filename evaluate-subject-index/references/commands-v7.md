...
```bash
python scripts/candidate_preparation_cli.py extract ...
python scripts/candidate_preparation_cli.py normalize ...
...
Registration is local and does not require publication evidence.
